 ...
 *
 * Every figure here is fixture/demo data — there is no Dashboard backend yet. The real
 * metrics, queries and role-scoped calculations are the Dashboard module (DASH-*, Sprint 5).
 * The banner keeps the placeholder honest so the numbers are never mistaken for live figures.
 */
  ...
  return (
    <ContentContainer className="p-4 lg:p-6">
      <Alert tone="info" title="Sample dashboard — demo data only">
        These figures are placeholders that mirror the Workpex layout. Live,
        role-scoped metrics arrive with the Dashboard module (Sprint 5).
      </Alert>
